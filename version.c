...
const char * V_SREVISION="1ab92e55c44b";
const char * V_STAG="2014.12.0";
const char * V_BRANCH="crazyflie2";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=false;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x1ab92e55;
const uint16_t V_REVISION_1=0xc44b;
